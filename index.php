...
<html lang="en"> 
  ...
  <body>
	...
	<div id="aboutMe">
	  ...
	  <table class="contact-info" width="" cellspacing="5" cellpadding="" border="0">
	    <tr>
	      ...
	      <td> <a href="http://twitter.com/#!/thierrymoisan"> <i class="fa fa-twitter-sign"></i> @thierrymoisan</a></td>
	      <td><a href="http://ca.linkedin.com/in/thierrymoisan"><i class="fa fa-linkedin-sign"></i>  Linkedin</a></td>
	    </tr>
	    <tr>
	      <td><a href="https://github.com/Moisan"><i class="fa fa-github-sign"></i>  Github</a></td>
	...
	<div id="searchInterests">
	  <h1><i class="fa fa-search"></i> Research interests</h1>
